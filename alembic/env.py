...
# Import ContextVault database configuration and models
from contextvault.config import get_database_url
...
from contextvault.models.routing import ModelCapabilityProfile, RoutingDecision
...
# Set the database URL from ContextVault config
